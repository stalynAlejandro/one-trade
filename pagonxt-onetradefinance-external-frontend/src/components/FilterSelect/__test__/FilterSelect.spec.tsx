...
describe('Component FilterSelect', () => {
  ...
  it('does not execute the provided onChange method when new options are selected', () => {
    ...
    getSelect(true);
    userEvent.click(screen.getByText(defaultProps.options[2].label));
  ...
  it('does not execute the provided onChange method when options are deselected', () => {
    ...
    getSelect(true);
    userEvent.click(screen.getByText(defaultProps.options[1].label));
  ...
  it('clicking the number of selected items does not clear the selection', () => {
    renderWithProps();
    userEvent.click(screen.getByTestId('filter-select-indicator'));
    expect(defaultProps.onChange).not.toBeCalled();
  });
  ...
  it('clicking the Clean All button clears the selection', () => {
    ...
    getSelect(true);
    userEvent.click(screen.getByText('T_cleanAll'));
