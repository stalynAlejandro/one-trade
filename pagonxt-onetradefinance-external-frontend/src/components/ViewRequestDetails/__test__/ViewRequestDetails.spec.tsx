...
describe('Component ViewRequestDetails', () => {
  ...
  describe('Detailed information', () => {
    it('shows detailed information when clicking on "See details" button', async () => {
      ...
      userEvent.click(screen.getByText('T_seeDetails'));
      expect(
    ...
    it('hides the detailed information when clicking on "Hide details" button', async () => {
      ...
      userEvent.click(screen.getByText('T_hideDetails'));
      await waitFor(() =>
        expect(
  ...
  describe('Comments modal', () => {
    ...
    it('displays the comments modal when Comments button is clicked', async () => {
      await waitForRenderWithProps();
      userEvent.click(screen.getByText('T_comments'));
  ...
  describe('Historic modal', () => {
    ...
    it('displays the historic modal when Historic button is clicked', async () => {
      await waitForRenderWithProps();
      userEvent.click(screen.getByText('T_historic'));
  ...
  describe('Comments and historic modal cli events', () => {
    ...
    beforeEach(() => {
      ...
      fetchMock.mock(
        ApiUrls.requestComments(defaultCliProps.requestId, 'es_es'),
        commentsMockedResponse,
        {
          overwriteRoutes: true,
        },
      ...
      fetchMock.mock(
        ApiUrls.requestHistoric(defaultCliProps.requestId, 'es_es'),
        historicMockedResponse,
        {
          overwriteRoutes: true,
        },
    ...
    it('render with CLI props the contextual buttons', async () => {
      await act(() => {
    ...
    it('on cli events displays the comments modal when Comments button is clicked', async () => {
      renderWithProps(defaultCliProps);
    ...
    it('on cli events displays the historic modal when Historic button is clicked', async () => {
      renderWithProps(defaultCliProps);
