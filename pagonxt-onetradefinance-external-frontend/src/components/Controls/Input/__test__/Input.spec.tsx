...
describe('Control Input', () => {
  ...
  describe('Text input', () => {
    ...
    it('changes the value and calls to the provided onChange method when typing', () => {
      renderWithProps();
      const str = 'test';
      const input = getInput();
      userEvent.paste(input, str);
  ...
  describe('Number input', () => {
    ...
    it('changes the value with the correct format and calls to the provided onChange method with decimals when typing', () => {
      renderWithProps();
