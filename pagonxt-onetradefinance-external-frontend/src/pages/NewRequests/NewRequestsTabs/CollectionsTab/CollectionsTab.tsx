...
const CollectionsTab: React.FC = () => {
  ...
  const exportationItems = [
    ...
    },
    {
      ...
      icon: 'analysis',
      onClick: () => navigateIfDev(Navigation.forms.cle.otherOperations.create),
  ...
  const importationItems = [
    {
      ...
      icon: 'add',
      onClick: () => navigateIfDev(Navigation.forms.cli.request.create),
      title: t('collectionsTab.admission'),
    },
    {
      description: t('collectionsTab.modificationDescription'),
      icon: 'edit',
      onClick: () => navigateIfDev(Navigation.forms.cli.modification.create),
      title: t('collectionsTab.modification'),
    },
    {
    ...
    },
    {
      description: t('collectionsTab.otherOperationsDescription'),
      icon: 'analysis',
      onClick: () => navigateIfDev(Navigation.forms.cli.otherOperations.create),
      title: t('collectionsTab.otherOperations'),
    },
  ];
