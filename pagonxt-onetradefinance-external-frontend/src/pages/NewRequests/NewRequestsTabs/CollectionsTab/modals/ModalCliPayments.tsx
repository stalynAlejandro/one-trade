  ...
  return (
    <>
      <SquaredCard
        ...
        onClick={() => navigateIfDev(Navigation.forms.cli.paymentCharge.create)}
      />
      <SquaredCard
        className="actionModal__action"
        icon="financing-gear"
        ...
        onClick={() =>
          navigateIfDev(Navigation.forms.cle.advanceModification.create)
        }
      />
      <SquaredCard
        className="actionModal__action"
        ...
        onClick={() =>
          navigateIfDev(Navigation.forms.cli.paymentAccountless.create)
        }
      />
    </>
  );
