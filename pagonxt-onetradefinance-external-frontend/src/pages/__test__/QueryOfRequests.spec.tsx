...
describe('Page QueryOfRequests', () => {
  ...
  it('cli request - navigates to Continue if is a draft and the action continue is clicked', async () => {
    await renderPage();
  ...
  it('cli mod - opens the detail page of the selected CLI request when consult is pressed', async () => {
