...
describe('Page NewRequests', () => {
  ...
  describe('Collections tab', () => {
    ...
    describe('Not implemented in PROD', () => {
      it('does not redirect to Other Operations form when clicking the specified product', () => {
        renderPageInTab(tabs.collections);

        userEvent.click(
          screen.getAllByText('T_collectionsTab.otherOperations')[0],
        );
        expect(mockedUsedNavigate).not.toHaveBeenCalledWith(
          Navigation.forms.cle.otherOperations.create,
        );
        expect(mockedUsedNavigate).not.toHaveBeenCalled();
      });

      it('does not redirect to CLI New Collection form when clicking the specified product', () => {
        renderPageInTab(tabs.collections);
      ...
      it('does not redirect to CLI Modify Collection form when clicking the specified product', () => {
        renderPageInTab(tabs.collections);
      ...
      it('does not redirect to CLI Other Operations Creation form when clicking the specified product', () => {
        renderPageInTab(tabs.collections);
