...
describe('Page PendingTasks', () => {
  ...
  it('can continue cli request Form when request is Draft and the action Continue is clicked', async () => {
    await renderPage();
  ...
  it('can continue cli payment charge Form when status is Draft and the action Continue is clicked', async () => {
    await renderPage();
  ...
  it('can continue cli payment accountless Form when status is Draft and the action Continue is clicked', async () => {
    await renderPage();
  ...
  it('can not continue Form when request is different from Draft and the action Continue is clicked', async () => {
    await renderPage();
