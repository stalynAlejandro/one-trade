...
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cle/advanceModification/completeInformation';
...
describe('Form CLE ADVANCE MODIFICATION CreateForm', () => {
  ...
  beforeEach(() => {
    ...
    fetchMockJest.mock(
      ApiUrls.cle.advanceModification.create.confirm,
      {
