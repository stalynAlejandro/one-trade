...
import { get as completeInfoResponse } from '../../../../../testUtils/mocks/data/cle/advanceModification/completeInformation';
...
describe('Form CLE ADVANCE MODIFICATION CompleteInformationForm', () => {
  const taskId = 'TSK-123456789';
  const getUrl = `${ApiUrls.cle.advanceModification.completeInformation.get(
    taskId,
    true,
  )}`;
  ...
  it('fetches and loads the data of the request successfully', async () => {
    ...
    expect(screen.getByText(request.riskLine.iban)).toBeInTheDocument();
