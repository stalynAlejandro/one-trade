...
import { StLabelHasAccount } from '../CompleteInformationFormStyled';
import { InputSelect } from '../../../../../components/Controls/InputSelect';
import {
  StButtonContainerLeft,
  ...
  return (
    ...
    >
      <form>
        ...
        />
        {fieldsState.commissionAccount?.value &&
          fieldsState.clientAccount?.value && (
            <StButtonContainerLeft>
              <Button
                inverse
                label={t('exchangeInsurance')}
                onClick={resetFieldsState}
              />
            </StButtonContainerLeft>
          )}
        <Select
