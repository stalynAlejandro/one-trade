...
import { formData } from '../../../../../testUtils/mocks/data/cli/financingModification/formData';
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cli/financingModification/completeInformation';
...
describe('Form CLI FINANCING MODIFICATION CreateForm', () => {
  ...
  beforeEach(() => {
    ...
    fetchMockJest.mock(
      ApiUrls.cli.financingModification.create.confirm,
      {
