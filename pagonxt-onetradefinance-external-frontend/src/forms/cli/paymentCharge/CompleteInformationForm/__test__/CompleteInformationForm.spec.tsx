...
import { get as completeInfoResponse } from '../../../../../testUtils/mocks/data/cli/paymentCharge/completeInformation';
...
describe('Form CLI PAYMENT CHARGE CompleteInformationForm', () => {
  const taskId = 'TSK-123456789';
  const getUrl = `${ApiUrls.cli.paymentCharge.completeInformation.get(
    taskId,
    true,
  )}`;
  ...
  beforeEach(() => {
    ...
    fetchMockJest.mock(
      ApiUrls.cli.paymentCharge.completeInformation.complete(taskId),
      {
        body: {
