...
import { formData } from '../../../../../testUtils/mocks/data/cli/modification/formData';
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cli/modification/completeInformation';
...
describe('Form CLI MODIFICATION CreateForm', () => {
  ...
  beforeEach(() => {
    ...
    fetchMockJest.mock(
      ApiUrls.cli.modification.create.confirm,
      {
