...
import { get as completeInfoResponse } from '../../../../../testUtils/mocks/data/cli/otherOperations/completeInformation';
...
describe('Form CLI OTHER OPERATIONS CompleteInformationForm', () => {
  const taskId = 'TSK-123456789';
  const getUrl = `${ApiUrls.cli.otherOperations.completeInformation.get(
    taskId,
    true,
  )}`;
  ...
  beforeEach(() => {
    ...
    fetchMockJest.mock(
      ApiUrls.cli.otherOperations.completeInformation.complete(taskId),
      {
        body: {
