...
import { formData } from '../../../../../testUtils/mocks/data/cli/otherOperations/formData';
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cli/otherOperations/completeInformation';
...
describe('Form CLI OTHER OPERATIONS CreateForm', () => {
