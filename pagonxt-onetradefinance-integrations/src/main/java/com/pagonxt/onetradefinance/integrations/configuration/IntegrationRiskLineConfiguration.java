 ...
 * @see com.pagonxt.onetradefinance.integrations.configuration.IntegrationRiskLineConfiguration
 * @since jdk-11.0.13
 */
@Configuration
public class IntegrationRiskLineConfiguration {
     ...
     * @param integrationRiskLineProperties : Properties for this class
     */
    public IntegrationRiskLineConfiguration(ApiErrorHandler apiErrorHandler,
     ...
     */
    @Bean
    public RestTemplate restTemplateRiskLine() {
        HttpComponentsClientHttpRequestFactory clientHttpRequestFactory =
                generateFactory(integrationRiskLineProperties.getTimeout());
     ...
     */
    @Bean
    public HttpHeaders httpHeadersRiskLine() {
