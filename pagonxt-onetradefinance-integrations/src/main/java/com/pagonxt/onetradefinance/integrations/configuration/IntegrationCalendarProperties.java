 ...
 */
@Configuration
@ConfigurationProperties(prefix = "one-trade.integrations.calendar")
public class IntegrationCalendarProperties {

    /**
     * Use a mock calendar service instead of a real integration.
