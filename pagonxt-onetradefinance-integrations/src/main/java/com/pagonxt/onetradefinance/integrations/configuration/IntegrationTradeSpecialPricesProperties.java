 ...
 */
@Configuration
@ConfigurationProperties(prefix = "one-trade.integrations.special-prices")
public class IntegrationTradeSpecialPricesProperties {

    /**
     * Use a mock trade special prices service instead of a real integration.
