 ...
 */
@Configuration
@ConfigurationProperties(prefix = "one-trade.integrations.risk-line")
public class IntegrationRiskLineProperties {

    /**
     * Use a mock risk line service instead of a real integration.
