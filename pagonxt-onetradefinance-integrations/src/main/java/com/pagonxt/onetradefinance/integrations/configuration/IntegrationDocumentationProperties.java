 ...
 */
@Configuration
@ConfigurationProperties(prefix = "one-trade.integrations.documentation")
public class IntegrationDocumentationProperties {

    /**
     * Use a mock documentation service instead of a real integration.
