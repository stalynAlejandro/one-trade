...
class ModelPackageTest {
    private static final String PACKAGE_NAME = "com.pagonxt.onetradefinance.integrations.model";

    @Test
    void validate() {
        List<String> filteredOutClasses = List.of("DocumentMultipartFile", "TradeSpecialPricesQueryBuilder", "BusinessLogOperationStatus");
