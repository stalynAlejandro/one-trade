...
@UnitTest
class UserInfoStdSerializerTest {
    ...
    private final UserInfoStdSerializer userInfoStdSerializer = new UserInfoStdSerializer();
    ...
    void whenSerializingDocument_ok_returnsValidData() throws IOException {
        ...
        JsonNode expectedJsonNode = mapper.readTree(new ClassPathResource("data/model/serialized-user-info.json").getFile());

        // When
        userInfoStdSerializer.serialize(userInfo, jsonGenerator, mapper.getSerializerProvider());
        jsonGenerator.flush();
