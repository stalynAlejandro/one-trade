...
@UnitTest
class ExportCollectionAdvanceCancellationRequestStdSerializerTest {

    private static final String TIMEZONE = "Europe/Madrid";
    private static final String DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";

    private static ExportCollectionAdvanceCancellationRequestStdSerializer exportCollectionAdvanceCancellationRequestStdSerializer;
    ...
    static void setup() {
        ...
        exportCollectionAdvanceCancellationRequestStdSerializer = new ExportCollectionAdvanceCancellationRequestStdSerializer(dateFormatProperties);
    }
    ...
    void whenSerializingExportCollectionAdvanceRequest_ok_returnsValidDates() throws IOException {
        ...
        ExportCollectionAdvanceCancellationRequest request = mapper.readValue(new ClassPathResource("data/model/cle/export-collection-advance-cancellation-request-not-serialized-dates.json").getFile(), ExportCollectionAdvanceCancellationRequest.class);
        // When
        exportCollectionAdvanceCancellationRequestStdSerializer.serialize(request, jsonGenerator, mapper.getSerializerProvider());
        jsonGenerator.flush();
