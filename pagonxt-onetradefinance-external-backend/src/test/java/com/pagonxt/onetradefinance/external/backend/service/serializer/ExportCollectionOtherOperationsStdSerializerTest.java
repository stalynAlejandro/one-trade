...
class ExportCollectionOtherOperationsStdSerializerTest {

    private static final String TIMEZONE = "Europe/Madrid";
    private static final String DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";

    private static ExportCollectionOtherOperationsRequestStdSerializer exportCollectionOtherOperationsRequestStdSerializer;
    ...
    static void setup() {
        ...
        exportCollectionOtherOperationsRequestStdSerializer = new ExportCollectionOtherOperationsRequestStdSerializer(dateFormatProperties);
    }
    ...
    void whenSerializingExportCollectionModificationRequest_ok_returnsValidDates() throws IOException {
        ...
        ExportCollectionOtherOperationsRequest request = mapper.readValue(new ClassPathResource("data/model/cle/export-collection-other-operations-request-not-serialized-dates.json").getFile(), ExportCollectionOtherOperationsRequest.class);
        // When
        exportCollectionOtherOperationsRequestStdSerializer.serialize(request, jsonGenerator, mapper.getSerializerProvider());
        jsonGenerator.flush();
