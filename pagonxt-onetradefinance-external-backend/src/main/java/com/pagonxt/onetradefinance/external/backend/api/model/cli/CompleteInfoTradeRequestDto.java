 ...
 * @since jdk-11.0.13
 */
public class CompleteInfoTradeRequestDto {
    ...
    private CommonRequestDto request;
    ...
    public CommonRequestDto getRequest() {
        return request;
    }

    public void setRequest(CommonRequestDto request) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        CompleteInfoTradeRequestDto that = (CompleteInfoTradeRequestDto) o;
    ...
    public String toString() {
        return "CompleteInfoTradeRequestDto{" +
