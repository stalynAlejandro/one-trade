...
/**
 * DTO Class for import collection request
 ...
 * @since jdk-11.0.13
 */
public class ImportCollectionRequestDto extends CommonRequestDto {
    ...
    public boolean equals(Object o) {
        ...
        ImportCollectionRequestDto that = (ImportCollectionRequestDto) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(contractReference, slaEnd, savedStep, operationDetails);
    }
    ...
    public String toString() {
        return "ImportCollectionRequestDto{" +
